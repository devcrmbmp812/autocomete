					...
					<div class="template-header-top'.(self::isPage('404') ? ' template-header-top-static' : null).'">
						...
						<div class="template-header-top-menu template-main">
							<nav>
								...
								<div class="template-component-menu-default">
									<ul class="sf-menu">
										'.self::createMenuItem('home','Accueil').'								
										'.self::createMenuItem('about','À propos de nous').'
										'.self::createMenuItem('gallery','Galerie').'
										'.self::createMenuItem('book-your-wash','Rendez-vous').'
										'.self::createMenuItem('contact','Nous joindre').'
						...
						<div class="template-header-top-icon-list template-component-social-icon-list-1">
							<ul class="template-component-social-icon-list">
								...
								<li><a href="https://www.instagram.com/auto_comete/" class="template-icon-social-instagram" target="_blank"></a></li>
