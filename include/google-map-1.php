			...
			<div class="template-component-google-map">
				...
				<a href="#" class="template-component-google-map-button">
					...
					<span class="template-component-google-map-button-label-show">Afficher la carte</span>
					<span class="template-component-google-map-button-label-hide">Masquer la carte</span>
				</a>
