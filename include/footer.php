					...
					<div class="template-main">
						...
						<div class="template-footer-bottom">
							...
							<div class="template-footer-bottom-copyright">
								By <a href="http://www.vortexapp.ca" target="_blank">Vortexapp</a> &copy; 2018 Autocomete
							</div>
				...
				<script type="text/javascript" src="script/DateTimePicker.min.js"></script>
						<script src="https://maps.google.com/maps/api/js?key=AIzaSyBZjTQntQ7S2I5-Y7m0K4bh-bRb7seluCI"></script>
				...
				<script src="https://www.vortexapp.ca/instashow/elfsight-instagram-feed.js"></script>
