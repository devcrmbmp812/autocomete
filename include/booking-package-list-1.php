		...
		<li>
			...
			<div class="template-component-booking-item-header template-clear-fix">
				...
				<h3>Wash packages</h3>
				<h5>Quel lavage convient le mieux à votre véhicule?</h5>
			</div>
			...
			<div class="template-component-booking-item-content">
				...
				<ul class="template-component-booking-package-list">
					...
					<li data-id="basic-hand-wash-1" data-id-vehicle-rel="regular-size-car">
						...
						<!-- Header -->
						<h4 class="template-component-booking-package-name">Lavage Intérieur & Extérieur <br> Prix promotionel</h4>
						...
						<div class="template-component-button-box">
							<a href="#" class="template-component-button">Réserver maintenant</a>
						</div>
					...
					<!-- Package -->
					<li data-id="deluxe-wash-1" data-id-vehicle-rel="pickup-truck">
						<h4 class="template-component-booking-package-name">Lavage Intérieur & Extérieur <br> Prix promotionel</h4>
						<div class="template-component-booking-package-price">
							<span class="template-component-booking-package-price-currency">$</span>
							<span class="template-component-booking-package-price-total">35</span>
